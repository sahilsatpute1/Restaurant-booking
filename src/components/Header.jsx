    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
      ...
      <div className='hidden md:flex w-full h-full  items-center justify-between'>
        <Link to={'/'} className='flex items-center gap-2'>
          ...
          <p className='text-headingColor text-xl font-bold w-8'> FoodieZone </p>
        </Link>
        ...
        <div className='relative'>
            ...
            />
          {
            ...
            <motion.div initial={{opacity:0, scale: 0.6}} animate={{opacity:1, scale: 1}} exit={{opacity:0, scale: 0.6}} className='w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-12 right-0'>
              {
                user && user.email === "sahilsatpute05@gmail.com" && (
                  <Link to={"/createItem"}>
      ...
      <div className='flex items-center justify-between md:hidden w-full h-full '>
        ...
        <Link to={'/'} className='flex items-center gap-2'>
            <img src={Logo} className="w-10 object-cover" alt="logo" />
            <p className='text-headingColor text-xl font-bold w-8'> City </p>
        </Link>
